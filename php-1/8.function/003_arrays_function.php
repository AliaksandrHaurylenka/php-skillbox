...
array_unshift($library["books"], [
    'title' => 'Рефакторинг кода на JavaScript: улучшение проекта существующего кода',
    'author' => 'martin_fauler@example.com',
    'year' => 2019,
]);
var_dump($library);
